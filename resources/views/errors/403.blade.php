                    ...
                    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                        <div class="card-content">
                            <div class="card-body text-center">
                                <img src="{{asset('build/app-assets/images/pages/not-authorized.png')}}" class="img-fluid align-self-center" alt="branding logo">
                                <h1 class="font-large-2 my-2">Yetkisiz İşlem!</h1>
                                <p class="p-2">
                                    Güvenlik politikalarına göre bu alana erişmek için gerekli yetkilere sahip değilsiniz!
                                    <br>
                                    Bir yanlışlık olduğunu düşünüyorsanız kuruluşunuz ile iletişime geçiniz.
                                </p>
                                <a class="btn btn-primary btn-lg mt-2" href="{{route('dashboard')}}">Geri Dön</a>
                            </div>
                        </div>
                    </div>
                </div>
