                    ...
                    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                        <div class="card-content">
                            <div class="card-body text-center">
                                <img src="{{asset('build/app-assets/images/pages/500.png')}}" class="img-fluid align-self-center" alt="branding logo">
                                <h1 class="font-large-2 mt-1 mb-0">Internal Server Error!</h1>
                                <p class="p-3">
                                    Anlaşılan yanlış giden bir şeyler oldu ama merak etmeyin siz bir kahve içene kadar sorunu çözmüş oluruz.
                                </p>
                                <a class="btn btn-primary btn-lg" href="index.html">Canınız sağolsun. Beni geri götürün</a>
                            </div>
                        </div>
                    </div>
                </div>
